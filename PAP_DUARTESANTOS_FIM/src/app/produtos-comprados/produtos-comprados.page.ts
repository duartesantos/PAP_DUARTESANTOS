...
@Component({
  ...
  templateUrl: './produtos-comprados.page.html',
  styleUrls: ['./produtos-comprados.page.scss'],
})
export class ProdutosCompradosPage implements OnInit {
  ...
  carregar(){
    return new Promise(resolve => {
      ...
      let dados = {
        ...
        this.provider.dadosApi(dados, 'produtos-comprados/listar.php').subscribe(data => {
