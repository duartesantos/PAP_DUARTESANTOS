...
@Component({
  selector: 'app-tarefas-feitas-filho',
  templateUrl: './tarefas-feitas-filho.page.html',
  styleUrls: ['./tarefas-feitas-filho.page.scss'],
})
export class TarefasFeitasFilhoPage implements OnInit {
  itens : any = [];
  limit : number = 10;
  start : number = 0;
  nome : string = "";
  ...
  carregar(){
    return new Promise(resolve => {
      ...
      let dados = {
        ...
        this.provider.dadosApi(dados, 'tarefas-feitas-filho/listar.php').subscribe(data => {
